  ...
  <b-container fluid class="backg">
    ...
    <b-col cols="12" v-if="!isLoading">
      ...
      <b-form @submit="onSubmit">
        <b-container>
          <h3 style="font-type:bold;">{{ $t("search-home.title1") }}</h3>
          <hr />
          <h5>{{ $t("search-home.title2") }}</h5>
          <b-row class="kov-margin">
            <b-col>
              <b-form-group :label="$t('search-home.category')">
                <b-form-select
                ...
                >
                  ...
                  <option
                    ...
                    >{{ $t("kovhome.category" + "." + category.id) }}
                  </option>
                </b-form-select>
              </b-form-group>
            </b-col>
            <b-col>
              <!--b-form-group :label="$t('search-home.speciality')">
                <b-form-select v-model="form.specialityId" class="mb-3 select">
                  <option
...
<div v-if="address!=''"><vue-google-autocomplete 
     ...
     <div v-else>   <vue-google-autocomplete 
         ...
         <strong v-if="locationerror!=''" style="font-size:15px;color:red;font-weight:400;margin:5px;" >***{{locationerror}}</strong>
            ...
            <b-col>
              <b-form-group :label="$t('search-home.language')" >
...
import Multiselect from 'vue-multiselect';
 Vue.component('multiselect', Multiselect, NavSearch);
export default {
  mounted() {
  window.scrollTo(0,0);
        
    this.autocomplete_1 = new google.maps.places.Autocomplete(
      this.$refs.autocomplete_1,
      { types: ["geocode"] }
    );
  },
  name: "MainPage",
  ...
  created() {
    ...
    if (self.categoryId) {
      ...
      console.log("ID", self.form.categoryId, "jbj", self.categoryId);
