<template>
                ...
                >
                  <b-card>
                    <b-row>
                      ...
                      <b-col class="text-center" lg="4" sm="6" md="6" xs="6">
						...
						<br/>
						<b-row>
						 <div style="display:inline-flex;" v-for="(itm,index) in item.branch_images"
                  :key="itm.id">
	              ...
	              <p v-if="index<3">
				   ...
				   <b-img
						  ...
						  @click="showGallery()"
                             style="margin:2px;width:50px;height:50px; border: 1px solid black;"
                         ></b-img>
		</p>
                          ...
                          <div class="slots inner text-center display">
                            ...
                            >
							 ...
							 <div v-if="item.video_consultation=='1'"><b-button 
                                        size="sm"
                                        style="color:white !important;background-color:#47aed8; margin: 3px !important;
  ...
  font-size: 12px !important !important;"
        ...
        <b-row class="justify-content-center" style="margin-top: 12px" v-if="this.manage">
          ...
          <b-col col lg="4" sm="12" md="12" class="pl-1" style="margin-top:65px;">
            {{ $t("search.filters") }} &nbsp;&nbsp;&nbsp;&nbsp;<v-btn  style="height:auto;font-weight:600;background-color:#edf9fc;;color:black;text-align:left;margin-left:10px;display:block !important;" @click="show_filters = !show_filters">
                     {{ $t("search.filters") }}<img v-bind:src="[ show_filters ? '/static/img/minus.png' : '/static/img/plus.png' ]" >
...
<transition>
			  ...
			  <p class="text-left">
			   ...
			   <strong style="font-weight:600;color:blue;text-align:left;margin-left:10px;display:block !important;"> {{ $t("search.map") }}<v-btn icon @click="show_map = !show_map">
                    <img v-bind:src="[ show_map ? '/static/img/minus.png' : '/static/img/plus.png' ]" >
