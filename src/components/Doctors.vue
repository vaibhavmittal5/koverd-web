        ...
        <b-row>
          <b-col cols lg="8" sm="12" md="12" >
            <!--b-alert show variant="success" style="color:black !important;background-color: rgba(0, 0, 0, 0.03) !important; border-color: rgba(0, 0, 0, 0.125)  !important; border-bottom: 1px solid rgba(0, 0, 0, 0.125) !important;"-->
                ...
                <h5 class="text-left" style="margin-bottom: 1rem !important;font-size:14px !important;margin-top:10px; margin-left:10px !important;color:#666161;">{{ $t('search.search')}} : Doctors in {{searchcity}}, {{searchcountry}}</h5>
...
<b-row>
 ...
 <br/>
 <input type="checkbox" 
                     @click="compare(item.id)" >&nbsp;<strong &nbsp;<strong
                          style="font-size:10px;color: #666161;font-weight: 400;">Add to compare</strong>
                          <br/><br/>
                        <router-link
...
<b-row style="overflow: scroll;
 ...
 <i v-if="active_slots==2" class="fa fa-arrow-circle-left" aria-hidden="true" style="color:green;margin-top:7px;" @click="activeSlots" align="left" ></i>
...
<b-col v-else>
                              ...
                              </b-col> <i v-if="active_slots==1" class="fa fa-arrow-circle-right" aria-hidden="true" style="color:green;margin-top:7px;" @click="activeSlots" align="right" ></i>
...
<b-col v-else>
                              ...
                              <i v-if="active_slots==1" class="fa fa-arrow-circle-right" aria-hidden="true" style="color:green;margin-top:7px;" @click="activeSlots" align="right" ></i>
                              <!--img v-if="active_slots==1" src="../assets/arrow-point-to-right-slots.png" height="10" width="15" style="margin-top:7px;" @click="activeSlots" align="right" /-->
...
<div style="color:#00a4bd;margin-left:9px;" align="left">Showing result: 1 to {{responses.length}} </div>
              <div v-if="this.load_data_message!=null">
               ...
               <b-btn
                ...
                <b-btn
                                size="sm" v-else class="load aqua-gradient color-block-5 mb-3 mx-auto  z-depth-1"   style="background-color:#007bff;"  @click="addServices">
                  {{loadmessage}}
                </b-btn>
<!--b-button @click="datePre()" variant="outline-primary" style="border-color: #ffffff; !important">
                    <img src="../assets/left-arrow.png" height="12" width="10" />
                  </b-button>
                ...
                >{{current_date}}</h5>
                  ...
                  <b-button @click="datePost()" variant="outline-primary" style="border-color: #ffffff; !important">
                    <img src="../assets/arrow-point-to-right.png" height="12" width="10" />
                  </b-button-->
              </div>
          ...
          <b-col col lg="3" sm="12" md="12" class="pl-1 " >

           <!--img src="../assets/location.png" height="25px" />
         <strong style="font-size:14px;color:gray;font-weight:400;text-align:left;" >{{ $t("search.map") }} </strong-->
  ...
  else
  {
    ...
    callack(id,speciality_filter) {
     ...
     //   let long = position.coords.longitude;
        ...
        axios.post("/services-doctors-new", dataToSend).then(function(response) {
    ...
    //  navigator.geolocation.getCurrentPosition(function(position) {
     ...
     //   let long = position.coords.longitude;
        ...
        axios
          .post("/services-doctors-new", dataToSend)
          .then(function(response) {
            //console.log("services-revised-date", response);
            self.setBranches(response.data.branches);
            let array = response.data.branches;
