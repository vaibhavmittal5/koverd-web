<template>
  <b-container fluid>
    ...
    <b-row class="justify-content-center" style="margin-top: 12px">
      <router-link to="/employee/register">Register yourself as a service provider?</router-link>
    </b-row>
    <b-row class="justify-content-center" style="margin-top: 12px">
      <router-link to="/password/user/reset">Forgot your password?</router-link>
    </b-row>
    <b-row class="justify-content-center" style="margin-top: 12px">
...
export default {
  ...
  methods: {
    ...
    resend () {
      let self = this
      axios.post('/verify/resend', {'email': this.form.email})
        .then(resp => {
