  ...
  <b-container fluid class="backg">
    ...
    <b-col cols="12" v-if="!isLoading">
      ...
      <b-form @submit="onSubmit">
        <b-container>
          <h3>{{ $t('search-rating.title1')}}</h3>
          <hr />
          <h5>{{ $t('search-rating.title2')}}</h5>
          <b-row style="align:right;">
            <b-col>
              <b-form-group :label="$t('search-rating.category')">
                <b-form-select
            ...
            <b-col>
              <!--b-form-group :label="$t('search-rating.speciality')">
...
<div v-if="address!=''"><vue-google-autocomplete 
     ...
     <div v-else>   <vue-google-autocomplete 
         ...
         <strong v-if="locationerror!=''" style="font-size:15px;color:red;font-weight:400;margin:5px;" >***{{locationerror}}</strong>
            ...
            <b-col>
              <b-form-group :label="$t('search-rating.language')">
